...
public class div_adapter extends ArrayAdapter<div>  {
    ...
    public div_adapter(Context context, int resource, ArrayList<div> objects,  ArrayList<last_price> last_prices) {
