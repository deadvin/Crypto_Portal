...
public class event_adapter extends ArrayAdapter<event> {
    ...
    public event_adapter(Context context, int resource, ArrayList<event> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(days < 2) {
            holder.time.setText("announced " + hours + ":" + min + " ago");
        }else{
            holder.time.setText("announced " + days + " days ago");
        }
